...
function Controls:init_options()
	...
	local shorthands = {
		['play-pause'] = 'cycle::pause:no/yes=?' .. t('Play/Pause'),
		['menu'] = 'command::script-binding uosc/menu-blurred?' .. t('Menu'),
		['subtitles'] = 'command::script-binding uosc/subtitles#sub>0?' .. t('Subtitles'),
		['audio'] = 'command::script-binding uosc/audio#audio>1?' .. t('Audio'),
		['audio-device'] = 'command::script-binding uosc/audio-device?' .. t('Audio device'),
		['video'] = 'command::script-binding uosc/video#video>1?' .. t('Video'),
		['playlist'] = 'command::script-binding uosc/playlist?' .. t('Playlist'),
		['chapters'] = 'command::script-binding uosc/chapters#chapters>0?' .. t('Chapters'),
		['editions'] = 'command::script-binding uosc/editions#editions>1?' .. t('Editions'),
		['stream-quality'] = 'command::script-binding uosc/stream-quality?' .. t('Stream quality'),
		['open-file'] = 'command::script-binding uosc/open-file?' .. t('Open file'),
		['items'] = 'command::script-binding uosc/items?' .. t('Playlist/Files'),
		['prev'] = 'command::script-binding uosc/prev?' .. t('Previous'),
		['next'] = 'command::script-binding uosc/next?' .. t('Next'),
		['first'] = 'command::script-binding uosc/first?' .. t('First'),
		['last'] = 'command::script-binding uosc/last?' .. t('Last'),
		['loop-playlist'] = 'cycle::loop-playlist:no/inf!?' .. t('Loop playlist'),
		['loop-file'] = 'cycle::loop-file:no/inf!?' .. t('Loop file'),
		['shuffle'] = 'toggle::shuffle?' .. t('Shuffle'),
		['fullscreen'] = 'cycle::fullscreen:no/yes=!?' .. t('Fullscreen'),
	}
